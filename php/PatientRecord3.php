...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "SELECT Patient_ID, Name, Age, Sex, Birth_Date, Barangay, Contact, Medical_Condition FROM PatientRecord3";
}
...
<body>
    <div class="sidebar">
        ...
        <button class="active" onclick="location.href='PatientRecord3.php'">Patient Record</button> <!-- Active button -->
    ...
    <div class="main-content">
        <!-- Main content area -->
        <form method="POST" action="PatientRecord3.php">
            <div class="filter-container">
                ...
                <button type="button" onclick="window.location.href='PatientRecord3.php'">Clear Filters</button>
            </div>
        </form>
